...
//                        height: 70,
                                ...
                                children: <Widget>[
                                  Text('Duration:',
                                      style: TextStyle(
                                          ...
                                          color: Color(0xff656565))),
                                  Text(
                                    '${_endDate.difference(_startDate).inDays} Day(s)',
                                    style: TextStyle(
                                        color: Color(0xffff6600),
                                        fontFamily: 'Verdana'),
                                  ),
                  ...
                  Positioned(
                    top: 180.0,
                    left: Platform.isIOS ? 70.0 : 70.0,
                    right: Platform.isIOS ? 70.0 : 70.0,
                    child: Container(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.done) {
            ...
            return IconButton(
                ...
                onPressed: () async {
                  Map response =
                      await util.addToRemoveFromWishList(Globals.eventId);
                  if (response['result']) {
                    setState(() {
