...
extension UILabel{
    ...
    func applyThemeToPlaceholder() {
        ...
        self.attributedText = NSAttributedString(string: self.text!, attributes: [NSForegroundColorAttributeName : UIColor.darkGray])
    }
...
extension UITextField{
    ...
    func applyThemeToPlaceholder() {
        self.attributedPlaceholder = NSAttributedString(string: self.placeholder!, attributes: [NSForegroundColorAttributeName : UIColor.darkGray])
