...
- (NSDictionary<NSString *, id> * _Nonnull)convertAttributesToJson SWIFT_WARN_UNUSED_RESULT;
- (NSString * _Nonnull)getFawryItemTitle SWIFT_WARN_UNUSED_RESULT;
- (UIImage * _Nonnull)getFawryItemImage SWIFT_WARN_UNUSED_RESULT;
@end
...
@property (nonatomic, strong) cardTokenizer * _Nullable card;
- (NSDictionary<NSString *, id> * _Nonnull)convertAttributesToJson SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) Fawry * _Nullable sharedInstance;)
+ (Fawry * _Nullable)sharedInstance SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
- (void)dispose;
- (void)applyFawryButtonStyleToButtonWithButton:(UIButton * _Nonnull)button;
@end
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) FawryPluginStartup * _Nonnull sharedInstance;)
+ (FawryPluginStartup * _Nonnull)sharedInstance SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end
...
@property (nonatomic, copy) NSString * _Null_unspecified productSKU;
@property (nonatomic, copy) NSString * _Null_unspecified productDescription;
- (nonnull instancetype)initWithProductSKUParam:(NSString * _Nonnull)productSKUParam productDescriptionParam:(NSString * _Nonnull)productDescriptionParam priceParam:(double)priceParam quantityParam:(NSInteger)quantityParam widthParam:(NSInteger)widthParam heightParam:(NSInteger)heightParam lengthParam:(NSInteger)lengthParam weightParam:(double)weightParam OBJC_DESIGNATED_INITIALIZER;
- (NSDictionary<NSString *, id> * _Nonnull)convertAttributesToJson SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end
